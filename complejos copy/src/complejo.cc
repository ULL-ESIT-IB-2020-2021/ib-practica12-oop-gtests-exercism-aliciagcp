...
Complejo operator*(Complejo &complejo, int real) {
int imaginario_multiplicacion{complejo._imaginario * real};
int real_multiplicacion{complejo._real * real};

Complejo numero{real_multiplicacion, imaginario_multiplicacion};
return numero;
}